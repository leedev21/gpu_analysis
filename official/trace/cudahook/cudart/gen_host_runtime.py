...
class $func_name$_PtrProvider {
 ...
 public:
  $func_name$_PtrProvider(void* h) : hook_(h) {
    cudaHookInit();
...
"""
    ...
    def generate_func(self):
        for func in self.header.functions:
            ...
            param_type = ""
            param_name = ""
            param_name_default = "v"
            for param in func["parameters"]:
                curr_name = param["name"]
                if curr_name=="":
                    print('param[name].empty()')
                    curr_name = param_name_default
                    param_name_default +="v"
                ...
                if param["array"] == 1:
                    param["type"] += "*"
                func_param += (param["type"] + " " + curr_name)
                param_type += param["type"]
                #print(param_name)
                param_name += curr_name               
